...
class Whistleblower(models.Model):
    ...
    nssf_number = models.CharField(max_length=900, null=True)
    type = models.CharField(max_length=900)
    date_submitted = models.DateTimeField()
    last_update = models.DateTimeField()
    user_id = models.CharField(max_length=900, blank=True, null=True)
    company_number = models.CharField(max_length=9000, null=True)
    company_name = models.CharField(max_length=9000, null=True)
    number_employees = models.CharField(max_length=900, null=True)
    physical_address = models.TextField()
    director = models.CharField(max_length=9000, null=True)
